...
public class ChamCong {
    ...
    public float getGioLam() {return gioLam;}
    public void setGioLam(float gioLam) {this.gioLam = gioLam;}
    public float getGioTangCa() {return gioTangCa;}
    public void setGioTangCa(float gioTangCa) {this.gioTangCa = gioTangCa;}
    public float getHsTangCa() {return hsTangCa;}
    public void setHsTangCa(float hsTangCa) {this.hsTangCa = hsTangCa;}
